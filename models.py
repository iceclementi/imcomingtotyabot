...
class User(object):
    ...
    def create_poll_from_template(self, temp_id: str, title: str, description: str) -> Poll | None:
        if temp_id not in self.get_all_temp_ids():
            return None
        temp_poll = PollTemplate.get_template_by_id(temp_id)
    ...
    def get_all_temp_ids(self) -> Set[str]:
        return self._temp_poll_ids.union(self._temp_list_ids).union(self.get_group_temp_ids())
